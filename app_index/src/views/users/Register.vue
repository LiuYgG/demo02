        ...
        <div class="regFormContent">
            ...
            <el-form class="regForm" :model="regForm" :rules="rules" ref="regForm" label-width="80px">
                ...
                <el-form-item label="登录名" prop="username">
                    <el-input v-model="regForm.username" placeholder="输入手机或邮箱"></el-input>
                </el-form-item>
                <el-form-item label="密码" prop="password">
                    <el-input v-model="regForm.password" placeholder="输入您要设置的密码"></el-input>
                </el-form-item>
                <el-form-item label="确认密码" prop="passwordConfirm">
                    <el-input v-model="regForm.passwordConfirm" placeholder="再次确认您的密码"></el-input>
                </el-form-item>
                <el-form-item>
